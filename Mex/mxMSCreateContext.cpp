...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	switch(imageres)
	{
        ...
        case 3:
			imagewidth=1280; imageheight=960;  res=NUI_IMAGE_RESOLUTION_1280x960; break;
		default :
			imagewidth=640; imageheight=480;  res=NUI_IMAGE_RESOLUTION_640x480; break;
	}
	
    //hr = m_pNuiInstance->NuiImageStreamOpen(NUI_IMAGE_TYPE_COLOR, res,0,2, NULL, &m_pVideoStreamHandle );
    hr = NuiImageStreamOpen(NUI_IMAGE_TYPE_COLOR, res,0,2, NULL, &m_pVideoStreamHandle );
    if( FAILED( hr ) )
    {
	...
	switch(depthres)
	{
        ...
        case 3:
			depthwidth=1280; depthheight=960;  res=NUI_IMAGE_RESOLUTION_1280x960; break;
		default :
    ...
    hr = NuiImageStreamOpen(NUI_IMAGE_TYPE_DEPTH_AND_PLAYER_INDEX,res,0,2, NULL,&m_pDepthStreamHandle );
    if( FAILED( hr ) )
    {
    ...
    //MXadress[0] = ( unsigned __int64)&m_pNuiInstance; //TODO!
